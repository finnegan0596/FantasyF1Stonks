...
namespace BlazorTable
{
    ...
    public partial class Column<TableItem> : IColumn<TableItem>
    {
        ...
        /// </summary>
        [Parameter]
        public Expression<Func<TableItem, object>> ImageUrl { get; set; }
        ...
        protected override void OnParametersSet()
        {
            ...
            if (Title == null && Field == null && ImageUrl == null)
            {
        ...
        /// <param name="data">data row</param>
        /// <returns></returns>
        public string RenderImage(TableItem data)
        {
            if (data == null || ImageUrl == null) return string.Empty;

            if (renderCompiled == null)
                renderCompiled = ImageUrl.Compile();
